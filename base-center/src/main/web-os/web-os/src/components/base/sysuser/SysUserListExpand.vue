/*admin_sys_user列表扩展,作者:高振中,日期:2018-12-14 09:36:53*/
<template>
  <div>
    <Row class="expand-row">
      <i-col span="6">
        <span class="expand-key">主键</span>
        <span class="expand-value">{{row.user_id}}</span>
      </i-col>
      <i-col span="6">
      ...
      <i-col span="6">
        <span class="expand-key">会员编号</span>
      ...
      <i-col span="6">
        ...
        <span class="expand-value">{{row.gender}}</span>
      </i-col>
      <i-col span="6">
      ...
      <i-col span="6">
        <span class="expand-key">部门ID</span>
        <span class="expand-value">{{row.department_id}}</span>
      </i-col>
      <i-col span="6">
        <span class="expand-key">微信号</span>
        <span class="expand-value">{{row.wechat}}</span>
      </i-col>
      <i-col span="6">
