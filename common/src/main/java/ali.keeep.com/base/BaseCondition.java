//package ali.keeep.com.base;
//
//import ali.keeep.com.util.SqlUtil;
...
//	private List<NameValue> order = new ArrayList<>();// 当前使用的排序字段
//
...
//		if (order.size() > 0) {
//			sql += " ORDER BY ";
//			for (NameValue entry : order) {
//				if (!StringUtils.isEmpty(entry.getName()) && !StringUtils.isEmpty(entry.getValue())) {
//					sql += orderMap.get(entry.getName()) + " " + entry.getValue() + ",";
//				}
//			}
...
//	}
//
//	public List<NameValue> getOrder() {
//		return order;
//	}
//
//	public void setOrder(List<NameValue> order) {
//		this.order = order;
//	}
//
//
